...
return [
    ...
    | and used as needed; however, this mailer is used by default.
    |
    */
    ...
    | sending an email. You may specify which one you're using for your mailers
    | below. You may also add additional mailers as needed.
    |
