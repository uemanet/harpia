<div class="row">
    ...
    <div class="form-group col-md-2 @if ($errors->has('doc_dataexpedicao')) has-error @endif">
        {!! Form::label('doc_dataexpedicao', 'Data de expedição*', ['class' => 'control-label']) !!}
        <div class="controls">
            {!! Form::text('doc_dataexpedicao', old('doc_dataexpedicao'), ['class' => 'form-control datepicker', 'data-provide' => 'datepicker', 'date-date-format' => 'dd/mm/yyyy']) !!}
            @if ($errors->has('doc_dataexpedicao')) <p class="help-block">{{ $errors->first('doc_dataexpedicao') }}</p> @endif
        </div>
    </div>
</div>
<div class="row">
