<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('crs_dep_id')) has-error @endif">
        {!! Form::label('crs_dep_id', 'Tipo de Documento*', ['class' => 'control-label']) !!}
        <div class="controls">
            {!! Form::select('crs_dep_id', $tiposdocumentos, old('crs_dep_id'), ['placeholder' => 'Selecione um departamento','class' => 'form-control']) !!}
