<div class="row">
    <div class="form-group col-md-6 @if ($errors->has('tit_nome')) has-error @endif">
        <label for="tit_nome" class="form-label">Nome da titulação*</label>
        <div class="controls">
            <input type="text" name="tit_nome" value="{{ old('tit_nome', $titulacao->tit_nome ?? '') }}" class="form-control" >
    ...
    <div class="form-group col-md-6 @if ($errors->has('tit_peso')) has-error @endif">
        <label for="tit_peso" class="form-label">Peso*</label>
        <div class="controls">
            <input type="number" name="tit_peso" value="{{ old('tit_peso', $titulacao->tit_peso ?? '') }}" class="form-control" >
...
<div class="row">
    <div class="form-group col-md-12 @if ($errors->has('tit_descricao')) has-error @endif">
        <label for="tit_descricao" class="form-label">Descrição</label>
        <div class="controls">
            <textarea name="tit_descricao" class="form-control">{{ old('tit_descricao', $titulacao->tit_descricao ?? '') }}</textarea>
