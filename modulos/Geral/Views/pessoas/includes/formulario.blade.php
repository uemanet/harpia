    ...
    <div class="form-group col-md-2 @if ($errors->has('pes_estado_civil')) has-error @endif">
        ...
        <div class="controls">
            <select name="pes_estado_civil" class="form-control">
                ...
                <option value="uniao_estavel" {{ old('pes_estado_civil', isset($pessoa->pes_estado_civil) ? $pessoa->pes_estado_civil : null) == 'uniao_estavel'  ? 'selected' : '' }}>União estável</option>
            </select>
