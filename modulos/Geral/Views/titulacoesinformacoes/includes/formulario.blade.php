<div class="row">
        ...
        <div class="controls">
            <select name="tin_tit_id" class="form-control">
                ...
                @foreach($titulacoes as $key => $value)
                    <option value="{{ $key }}" {{ old('tin_tit_id', $titulacaoInfo->tin_tit_id ?? '') == $key ? 'selected' : '' }}>{{ $value }}</option>
                @endforeach
            </select>
    ...
    <div class="form-group col-md-4 @if ($errors->has('tin_titulo')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="tin_titulo" value="{{ old('tin_titulo', $titulacaoInfo->tin_titulo ?? '') }}" class="form-control" >
    ...
    <div class="form-group col-md-4 @if ($errors->has('tin_instituicao')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="tin_instituicao" value="{{ old('tin_instituicao', $titulacaoInfo->tin_instituicao ?? '') }}" class="form-control" >
...
<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('tin_instituicao_sigla')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="tin_instituicao_sigla" value="{{ old('tin_instituicao_sigla', $titulacaoInfo->tin_instituicao_sigla ?? '') }}" class="form-control" >
    ...
    <div class="form-group col-md-4 @if ($errors->has('tin_instituicao_sede')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="tin_instituicao_sede" value="{{ old('tin_instituicao_sede', $titulacaoInfo->tin_instituicao_sede ?? '') }}" class="form-control" >
    ...
    <div class="form-group col-md-2 @if ($errors->has('tin_anoinicio')) has-error @endif">
        ...
        <div class="controls">
            <input type="number" name="tin_anoinicio" value="{{ old('tin_anoinicio', $titulacaoInfo->tin_anoinicio ?? '') }}" min="1" max="9999" maxlength="4" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" >
    ...
    <div class="form-group col-md-2 @if ($errors->has('tin_anofim')) has-error @endif">
        ...
        <div class="controls">
            <input type="number" name="tin_anofim" value="{{ old('tin_anofim', $titulacaoInfo->tin_anofim ?? '') }}" min="1" max="9999" maxlength="4" class="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" >
