<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('tin_tit_id')) has-error @endif">
        <label for="tin_tit_id" class="control-label">Titulações*</label>
        <div class="controls">
    ...
    <div class="form-group col-md-4 @if ($errors->has('tin_titulo')) has-error @endif">
        <label for="tin_titulo" class="control-label">Título/Curso*</label>
        <div class="controls">
    ...
    <div class="form-group col-md-4 @if ($errors->has('tin_instituicao')) has-error @endif">
      <label for="tin_instituicao" class="control-label">Instituição*</label>
      <div class="controls">
...
<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('tin_instituicao_sigla')) has-error @endif">
        <label for="tin_instituicao_sigla" class="control-label">Instituição Sigla*</label>
        <div class="controls">
    ...
    <div class="form-group col-md-4 @if ($errors->has('tin_instituicao_sede')) has-error @endif">
        <label for="tin_instituicao_sede" class="control-label">Instituição Sede*</label>
        <div class="controls">
    ...
    <div class="form-group col-md-2 @if ($errors->has('tin_anoinicio')) has-error @endif">
        <label for="tin_anoinicio" class="control-label">Ano Inicio*</label>
        <div class="controls">
    ...
    <div class="form-group col-md-2 @if ($errors->has('tin_anofim')) has-error @endif">
        <label for="tin_anofim" class="control-label">Ano Fim</label>
        <div class="controls">
