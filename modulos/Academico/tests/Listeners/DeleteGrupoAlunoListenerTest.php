 ...
 * @group Listeners
 */
class DeleteGrupoAlunoListenerTest extends ModulosTestCase
{
    protected $ambiente;
    ...
    public function testHandleWithSuccess()
    {
        ...
        $this->assertDatabaseHas('int_sync_moodle', [
            'sym_table' => $deleteGrupoAlunoEvent->getData()->getTable(),
            'sym_table_id' => $deleteGrupoAlunoEvent->getData()->getKey(),
            'sym_action' => $deleteGrupoAlunoEvent->getAction(),
            'sym_status' => 1,
            'sym_mensagem' => null,
            'sym_data_envio' => null,
            'sym_extra' => $deleteGrupoAlunoEvent->getExtra()
        ]);
