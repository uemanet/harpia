...
@section('scripts')
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var routeIndex = "{{ route('academico.relatoriossisuab.index') }}";
                ...
                $.harpia.httpget("{{url('/')}}/academico/async/ofertascursos/findallbycurso/" + cursoId).done(function (response) {
                    if (!$.isEmptyObject(response)) {
                        ...
                        $.each(response, function (key, obj) {
                            ofertasCursoSelect.append('<option value="' + obj.ofc_id + '">' + obj.ofc_ano + ' (' + obj.mdl_nome + ')' + (obj.itt_sigla ? ' ' + obj.itt_sigla : '') + '</option>');
                        });
                    } else {
