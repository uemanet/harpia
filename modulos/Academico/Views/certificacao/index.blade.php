        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="form-group col-md-2">
                    ...
                    {{ Form::select('mdo_id', [], null, ['class' => 'form-control', 'id' => 'mdo_id', 'required', 'value' => Request::input('pes_email'), 'placeholder' => 'Módulo']) }}
                </div>
                <div class="form-group col-md-2">
                        ...
                        .done(function (data) {
                            if (!$.isEmptyObject(data)) {
                                ...
                                $.each(data, function (key, obj) {
                                    ofertasCursoSelect.append(
                                        "<option value='" + obj.ofc_id + "'>" +
                                        obj.ofc_ano + " (" + obj.mdl_nome + ")" +
                                        (obj.itt_sigla ? " " + obj.itt_sigla : "") +
                                        "</option>"
                                    );
                                });
                            } else {
