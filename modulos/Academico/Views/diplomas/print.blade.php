...
@foreach($retorno as $dados)
    ...
    <div class="tudo" style="font-family: Arial; font-size:13px">
      ...
      <div class="divesquerda">
                <p style="text-align:center"><b>UNIVERSIDADE ESTADUAL DO MARANHÃO</b><br>
                  ...
                  Processo N° <b>{{$dados['PROCESSO']}}</b><br><br><br><br>
                  <?php
                  ...
                  <b>NOME DO PROFISSIONAL RESPONSÁVEL</b><br><br><br>
              </p>
      ...
      <div class="divdireita">
        <div style="padding: 20px 20px 0px 20px;border: 0.4mm solid;border-top-style:none;border-right-style: none;border-left-style: none;">
          Observação: Curso de Educação Profissional Técnica de Nível Médio - Subsequente<br><br><br>
                 ...
                 Matrícula: {{$dados['MATRICULADIRETORCURSO']}}<br><br>
        </div>
    ...
    <pagebreak>
        ...
        <p style="font-size:16pt; font-family: Arial;margin-left:0px; margin-right:50px; text-align:justify; line-height:1.5">
          A UNIVERSIDADE ESTADUAL DO MARANHÃO, por meio do {{$dados['CENTRO']}}, tendo em vista a conclusão do <b>Curso Técnico de Nível Médio em {{$dados['CURSO']}}</b>, em {{strftime('%d de %B de %Y', $dados['CONCLUSAO'])}}, confere o título de {{$dados['HABILITAÇÂO']}} a <b>{{$dados['NOME']}}</b>, nascido(a) aos {{$dados['DIAEXTENSO']}} {{strftime('dias do mês de %B de %Y', $dados['NASCIMENTO'])}}, nacionalidade {{$dados['NACIONALIDADE']}}, natural de {{$dados['NATURALIDADE']}}, carteira de identidade N° {{$dados['IDENTIDADE']}} / {{$dados['ORGAO']}}, outorga-lhe o  presente Diploma a fim de que possa gozar de todos os direitos e prerrogativas legais.
        </p>
