<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('crs_id')) has-error @endif">
        ...
        <div class="controls">
            {!! Form::select('crs_id', $cursos, $ofertaCurso->ofc_crs_id, ['class' => 'form-control select-control', 'placeholder' => 'Selecione um curso']) !!}
    ...
    <div class="form-group col-md-4 @if($errors->has('ofc_id')) has-error @endif">
        ...
        <div class="controls">
            {!! Form::select('ofc_id', $ofertas, $ofertaCurso->ofc_id, ['class' => 'form-control select-control']) !!}
    ...
    <div class="form-group col-md-4 @if ($errors->has('grp_trm_id')) has-error @endif">
        ...
        <div class="controls">
            {!! Form::select('grp_trm_id', $turmas, old('grp_trm_id'), ['class' => 'form-control']) !!}
...
<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('grp_pol_id')) has-error @endif">
        ...
        <div class="controls">
            {!! Form::select('grp_pol_id', $polos, old('grp_pol_id'), ['class' => 'form-control']) !!}
