...
@section('content')
    <div class="row">
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <div class="row">
                    <form method="GET" action="{{{ route('academico.centros.index') }}}" class="d-flex w-100">
                        <div class="col-md-9 px-1">
                            <input type="text" class="form-control" name="cen_nome" id="cen_nome" value="{{Request::input('cen_nome')}}" placeholder="Nome do centro">
                        </div>
