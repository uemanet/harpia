...
<div class="row">
    <div class="form-group col-md-12 @if ($errors->has('crs_descricao')) has-error @endif">
        ...
        <div class="controls">
            {!! Form::textarea('crs_descricao', old('crs_descricao'), ['class' => 'form-control']) !!}
            @if ($errors->has('crs_descricao')) <p class="help-block">{{ $errors->first('crs_descricao') }}</p> @endif
        </div>
    </div>
</div>
<div class="row">
    <div class="form-group col-md-12 @if ($errors->has('crs_resolucao')) has-error @endif">
        {!! Form::label('crs_resolucao', 'Resolução*', ['class' => 'control-label']) !!}
        <div class="controls">
            {!! Form::textarea('crs_resolucao', old('crs_resolucao'), ['class' => 'form-control']) !!}
            @if ($errors->has('crs_resolucao')) <p class="help-block">{{ $errors->first('crs_resolucao') }}</p> @endif
        </div>
    </div>
</div>
<div class="row">
    <div class="form-group col-md-12 @if ($errors->has('crs_autorizacao')) has-error @endif">
...
<div class="row">
    ...
    <div class="form-group col-md-12 @if ($errors->has('crs_eixo')) has-error @endif">
        {!! Form::label('crs_eixo', 'Eixo*', ['class' => 'control-label']) !!}
        <div class="controls">
            {!! Form::textarea('crs_eixo', old('crs_eixo'), ['class' => 'form-control']) !!}
            @if ($errors->has('crs_eixo')) <p class="help-block">{{ $errors->first('crs_eixo') }}</p> @endif
        </div>
    </div>
</div>
<div class="row">
    <div class="form-group col-md-12 @if ($errors->has('crs_habilitacao')) has-error @endif">
        {!! Form::label('crs_habilitacao', 'Habilitação*', ['class' => 'control-label']) !!}
        <div class="controls">
            {!! Form::textarea('crs_habilitacao', old('crs_habilitacao'), ['class' => 'form-control']) !!}
