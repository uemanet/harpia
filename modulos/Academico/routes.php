...
Route::group(['prefix' => 'academico', 'middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'matricularalunocurso'], function () {
        ...
        Route::put('/edit/{id}', '\Modulos\Academico\Http\Controllers\MatriculaCursoController@putEdit')->name('academico.matricularalunocurso.putEdit');
    ...
    Route::group(['prefix' => 'async'], function () {
        ...
        Route::group(['prefix' => 'turmas'], function () {
            ...
            Route::get('/findallwithvagasdisponiveis/{id}', '\Modulos\Academico\Http\Controllers\Async\Turmas@getFindallwithvagasdisponiveis');
        ...
        Route::group(['prefix' => 'modulosdisciplinas'], function () {
            ...
            Route::get('/getdisciplinasnotofertadasbymodulo/{modulo}/{turma}/{periodo}', '\Modulos\Academico\Http\Controllers\Async\ModulosDisciplinas@getDisciplinasNotOfertadasByModulo');
        ...
        Route::group(['prefix' => 'matricula'], function () {
            ...
            Route::get('/getmatriculasconcluidas', '\Modulos\Academico\Http\Controllers\Async\Matricula@getMatriculasConcluidas');
        });
    });
});
