...
class RelatoriosMatriculasController extends BaseController
{
    protected $matriculaCursoRepository;
    protected $cursoRepository;
    protected $turmaRepository;

    public function __construct(MatriculaCursoRepository $matricula, CursoRepository $curso, TurmaRepository $turmaRepository)
    {
    ...
    public function getIndex()
    {
        ...
        return view('Academico::relatoriosmatriculas.index', compact('cursos'));
    }
