<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('ban_nome')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="ban_nome" value="{{ old('ban_nome') }}" class="form-control" >
    ...
    <div class="form-group col-md-4 @if ($errors->has('ban_sigla')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="ban_sigla" value="{{ old('ban_sigla') }}" class="form-control" >
    ...
    <div class="form-group col-md-4 @if ($errors->has('ban_codigo')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="ban_codigo" value="{{ old('ban_codigo') }}" class="form-control" >
