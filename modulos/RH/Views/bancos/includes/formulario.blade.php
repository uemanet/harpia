<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('ban_nome')) has-error @endif">
        <label for="ban_nome" class="form-label">Nome do banco*</label>
        <div class="controls">
    ...
    <div class="form-group col-md-4 @if ($errors->has('ban_sigla')) has-error @endif">
        <label for="ban_sigla" class="form-label">Sigla*</label>
        <div class="controls">
    ...
    <div class="form-group col-md-4 @if ($errors->has('ban_codigo')) has-error @endif">
        <label for="ban_codigo" class="form-label">Código*</label>
        <div class="controls">
