<div class="row">
    ...
    <div class="form-group col-md-4 @if ($errors->has('col_data_admissao')) has-error @endif">
        ...
        <div class="controls">
            ...
            @if ($errors->has('col_data_admissao')) <p class="help-block">{{ $errors->first('col_data_admissao') }}</p> @endif
        </div>
    </div>
    ...
    <div class="form-group col-md-4 @if ($errors->has('col_codigo_catraca')) has-error @endif">
        ...
        <div class="controls">
            ...
            @if ($errors->has('col_codigo_catraca')) <p class="help-block">{{ $errors->first('col_codigo_catraca') }}</p> @endif
        </div>
    </div>
</div>
...
<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('col_vinculo_universidade')) has-error @endif">
        ...
        <div class="controls">
            {!! Form::select('col_vinculo_universidade', array('0' => 'Não', '1' => 'Sim'), null, ['class' => 'form-control', 'placeholder' => 'Selecione']) !!}
            @if ($errors->has('col_vinculo_universidade')) <p class="help-block">{{ $errors->first('col_vinculo_universidade') }}</p> @endif
        </div>
    </div>
    <div class="form-group col-md-3 @if ($errors->has('col_matricula_universidade')) has-error @endif">
        ...
        <div class="controls">
            ...
            @if ($errors->has('col_matricula_universidade')) <p class="help-block">{{ $errors->first('col_matricula_universidade') }}</p> @endif
        </div>
    </div>
    ...
    <div class="form-group col-md-2 @if ($errors->has('col_status')) has-error @endif">
        ...
        <div class="controls">
            {!! Form::select('col_status', array('ativo' => 'ativo', 'afastado' => 'afastado', 'desligado' => 'desligado'), null, ['class' => 'form-control', 'placeholder' => 'Selecione']) !!}
