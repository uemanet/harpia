...
<h3 class="card-title w-100 pb-3">
    <span style="font-weight: bold;"><i class="fa-solid fa-caret-right"></i> Dados do colaborador</span>
</h3>
<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('col_data_admissao')) has-error @endif">
        <label for="col_data_admissao" class="form-label">Data de admissão*</label>
        <div class="controls">
