...
@section('content')
    <div class="row">
        <div class="card card-primary card-outline p-0">
            ...
            <div class="card-body">
                <div class="row">
                <form method="GET" class="d-flex w-100" action="{{{ route('rh.periodoslaborais.index') }}}">
                    <div class="col-md-10 px-1">
                        <input type="text" class="form-control datepicker_us" name="pel_inicio" id="pel_inicio" value="{{Request::input('pel_inicio')}}" placeholder="Data de início">
                    </div>
