<div class="row">
    <div class="form-group col-md-3 @if ($errors->has('ccb_ban_id')) has-error @endif">
        <label for="ccb_ban_id" class="form-label">Banco*</label>
        <div class="controls">
    ...
    <div class="form-group col-md-3 @if ($errors->has('ccb_agencia')) has-error @endif">
        <label for="ccb_agencia" class="form-label">Agência*</label>
        <div class="controls">
    ...
    <div class="form-group col-md-3 @if ($errors->has('ccb_conta')) has-error @endif">
      <label for="ccb_conta" class="form-label">Conta*</label>
      <div class="controls">
    ...
    <div class="form-group col-md-3 @if ($errors->has('ccb_variacao')) has-error @endif">
        <label for="ccb_variacao" class="form-label">Variação*</label>
        <div class="controls">
