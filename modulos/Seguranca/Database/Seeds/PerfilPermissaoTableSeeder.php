...
class PerfilPermissaoTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $perfil->permissoes()->attach([87, 88, 89, 90]); // Permissoes do recurso Tutores

        $perfil->permissoes()->attach([91, 92, 93, 94]); // Permissoes do recurso Alunos
