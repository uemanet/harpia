...
class PerfilUsuarioTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $usuario = Usuario::where('usr_usuario', 'admin2@admin.com')->first(); // Usuario administrador
        $usuario->perfis()->attach([3]); // Atribui o perfil administrador do modulo academico para o usuario
    }
}
