<div class="row">
        ...
        <div class="form-group @if($errors->has('mit_mod_id'))has-error @endif">
            ...
            <select name="mit_mod_id" id="mit_mod_id" class="form-control">
                ...
                @foreach($modulos as $key => $value)
                    <option value="{{ $key }}" {{ old('mit_mod_id', $itemMenu->mit_mod_id ?? '') == $key ? 'selected' : '' }}>{{ $value }}</option>
                @endforeach
            </select>
    ...
    <div class="col-md-3">
        <div class="form-group @if($errors->has('mit_item_pai'))has-error @endif">
            ...
            <select name="mit_item_pai" id="mit_item_pai" class="form-control">
                <option value="">Selecione um item</option>
                @foreach($itens as $key => $value)
                    <option value="{{ $key }}" {{ old('mit_item_pai', $itemMenu->mit_item_pai ?? '') == $key ? 'selected' : '' }}>{{ $value }}</option>
                @endforeach
            </select>
    ...
    <div class="col-md-4">
        <div class="form-group @if($errors->has('mit_nome'))has-error @endif">
            ...
            <input type="text" name="mit_nome" value="{{ old('mit_nome', $itemMenu->mit_nome ?? '') }}" class="form-control" >
    ...
    <div class="col-md-2">
        <div class="form-group @if($errors->has('mit_icone'))has-error @endif">
            ...
            <input type="text" name="mit_icone" value="{{ old('mit_icone', $itemMenu->mit_icone ?? '') }}" class="form-control" >
    ...
    <div class="col-md-5">
        <div class="form-group">
            <div class="form-group @if($errors->has('mit_rota'))has-error @endif">
                ...
                <input type="text" name="mit_rota" value="{{ old('mit_rota', $itemMenu->mit_rota ?? '') }}" class="form-control" >
    ...
    <div class="col-md-6">
        <div class="form-group">
            <div class="form-group @if($errors->has('mit_descricao'))has-error @endif">
                ...
                <input type="text" name="mit_descricao" value="{{ old('mit_descricao', $itemMenu->mit_descricao ?? '') }}" class="form-control" >
...
@section('scripts')
    @vite('modulos/Seguranca/Resources/js/pages/menuitens/formulario.js')
@stop