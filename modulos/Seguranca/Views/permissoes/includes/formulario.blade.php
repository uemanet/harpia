<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('prm_nome')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="prm_nome" value="{{ old('prm_nome', $permissao->prm_nome ?? '') }}" class="form-control" >
    ...
    <div class="form-group col-md-4 @if ($errors->has('prm_rota')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="prm_rota" value="{{ old('prm_rota', $permissao->prm_rota ?? '') }}" class="form-control" >
    ...
    <div class="form-group col-md-4 @if ($errors->has('prm_descricao')) has-error @endif">
        ...
        <div class="controls">
            <input type="text" name="prm_descricao" value="{{ old('prm_descricao', $permissao->prm_descricao ?? '') }}" class="form-control" >
