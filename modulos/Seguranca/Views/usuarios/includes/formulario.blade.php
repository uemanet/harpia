<div class="row">
    <div class="form-group col-md-4 @if ($errors->has('usr_usuario')) has-error @endif">
        <label for="usr_usuario" class="form-label">Usuário de acesso*</label>
        <div class="controls">
            <input type="text" name="usr_usuario" value="{{ old('usr_usuario', $usuario->usr_usuario ?? '') }}" class="form-control" >
    ...
    <div class="form-group col-md-4 @if ($errors->has('usr_senha')) has-error @endif">
        <label for="usr_senha" class="form-label">Senha*</label>
        <div class="controls">
            {{-- Senha geralmente não se retorna no old() por segurança --}}
    ...
    <div class="form-group col-md-4 @if ($errors->has('usr_ativo')) has-error @endif">
        <label for="usr_ativo" class="form-label">Ativo*</label>
        <div class="controls">
            <select name="usr_ativo" class="form-control">
                <option value="1" {{ old('usr_ativo', $usuario->usr_ativo ?? 1) == 1 ? 'selected' : '' }}>Sim</option>
                <option value="0" {{ old('usr_ativo', $usuario->usr_ativo ?? 1) == 0 ? 'selected' : '' }}>Não</option>
            </select>
