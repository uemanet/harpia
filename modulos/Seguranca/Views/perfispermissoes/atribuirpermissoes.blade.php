...
@section('stylesheets')
    <link href="{{ asset('/assets/vendor/jsTree/dist/themes/default/style.min.css') }}" rel="stylesheet"/>
@stop

@section('title')
    <div class="row">
        <div class="col-md-8">
            <h2 style="margin:0px;font-size:30px" class="lead" >Atribuir Permissões</h2>
        </div>
    </div>
@stop
...
@section('content')
    <div class="panel panel-default ">
        <div class="panel-heading panel-heading-collapsed">
            <h3 style="margin:0px;font-size:25px" class="lead">Módulo: {{ $perfil->mod_nome }} | Perfil: {{ $perfil->prf_nome }}</h3>
        </div>
        <div class="panel-body">
            <div class="ibox float-e-margins wrapper wrapper-content">
                <div class="ibox-content">
                    ...
                    {!! Form::open(["url" => "/security/perfispermissoes/atribuirpermissoes", "method" => "POST", "role" => "form"]) !!}
